...
describe('This is first test suite, Ulle Turk', () => {
    ...
    */
     ...
     it('User cannot submit data when phone number is absent', () => {
        ...
        cy.get('#username').type('Malle')
        cy.get('input[name="password"]').type('MMesiMagus')
        cy.get('[name="confirm"]').type('MMesiMagus')
    ...
    it('User cannot submit data when password and/or confirmation password is absent', () => {
        ...
        cy.get('[data-testid="phoneNumberTestId"]').type('555222000')
        cy.get('input[name="password"]').type('MyPass123')
        cy.get('.submit_button').should('not.be.enabled')
        cy.get('#success_message').should('not.be.visible')
    ...
    it('User cannot add letters to phone number', () => {
        ...
        cy.get('#username').type('Katariina')
        cy.get('input[name="password"]').type('Fanta')
        cy.get('[name="confirm"]').type('Fanta')
        cy.get('.submit_button').should('not.be.enabled')
        cy.get('#success_message').should('not.be.visible')
